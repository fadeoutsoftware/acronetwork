...
import it.fadeout.acronetwork.business.config.RadarLinkConfig;
import it.fadeout.acronetwork.business.config.SatelliteLinkConfig;
...
import it.fadeout.acronetwork.viewmodels.HydroLink;
import it.fadeout.acronetwork.viewmodels.MapLink;
import it.fadeout.acronetwork.viewmodels.MapThirdLevelLink;
import it.fadeout.acronetwork.viewmodels.PrimitiveResult;
import it.fadeout.acronetwork.viewmodels.RadarLink;
import it.fadeout.acronetwork.viewmodels.SatelliteLink;
import it.fadeout.acronetwork.viewmodels.SensorLink;
import it.fadeout.acronetwork.viewmodels.StaticLink;
...
public class MapNavigatorService {
	...
	public PrimitiveResult ReloadConfig() {
		...
		try {
			...
			oConfig = Acronetwork.deserializeXMLToObject(sConfigFilePath);
	...
	public List<SensorLink> getSensorLinks(@HeaderParam("x-session-token") String sSessionId) {
		...
		if (oConfObj != null)  {
			AcronetworkNavigationConfig oConfig = (AcronetworkNavigationConfig) oConfObj;
	...
	public List<HydroLink> getHydroFirstLevelLinks(@HeaderParam("x-session-token") String sSessionId) {
		...
		if (Acronetwork.getUserFromSession(sSessionId)!= null) {
			Object oConfObj = m_oServletConfig.getServletContext().getAttribute("Config");
